          ...
          >
            ...
            >
              <div className="classifications">
                <h4 style={{ margin: 0 }}>Classifiers</h4>
            ...
            <section
              style={{ flex: "1", overflow: "scroll", maxHeight: "100%" }}
            >
              <table style={{ border: "1px dotted grey", width: "100%" }}>
                ...
                <tbody>
                  {predictions
                    .filter(
                      p =>
                        classifications[p.classifier] &&
                        ("model" in p ? models[p.model || ""] : true)
                    )
                    .map(prediction => {
                      ...
                      const play = <T extends {}>(_: React.MouseEvent<T>) => {
                        ...
                        const { peakInstance } = this.state;
                        if (current) {
                          const fraction = prediction.time / 1000;
